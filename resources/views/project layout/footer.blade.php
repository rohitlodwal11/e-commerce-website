                            ...
                            <div class="wrap-footer-item">
                                ...
                                <div class="item-content">
                                    <div class="wrap-list-item wrap-gallery">
                                        <img src="{{asset('public/assets/images/payment.png')}}" style="max-width: 260px;">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="wrap-list-item apps-list">
                                        <ul>
                                            <li><a href="#" class="link-to-item" title="our application on apple store">
                                                    <figure><img src="{{asset('public/assets/images/brands/apple-store.png')}}"
                                                            alt="apple store" width="128" height="36"></figure>
                                                </a></li>
                                            <li><a href="#" class="link-to-item"
                                                    title="our application on google play store">
                                                    <figure><img src="{{asset('public/assets/images/brands/google-play-store.png')}}"
