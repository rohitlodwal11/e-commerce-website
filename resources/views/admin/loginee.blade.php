...
<html lang="en">
  ...
  <body class="hold-transition login-page">
    ...
    <script src="{{asset('public/asset/dist/js/adminlte.min.js?v=3.2.0')}}"></script>
  </body>
</html>